...
public class Kruh {
    ...
    private void nakresli() {
        if (this.jeViditelny) {
            ...
            Ellipse2D myEll = new Ellipse2D.Double(this.lavyHornyX, this.lavyHornyY, 
                                                          this.priemer, this.priemer);                                         
            this.myEllShaped = myEll;                                              
            canvas.draw(this, this.farba, this.myEllShaped);
            //canvas.wait(2);
        }
    }
